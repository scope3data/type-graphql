...
export declare class MetadataStorage {
    ...
    authorizedFieldsByTargetAndFieldCache: Map<string, AuthorizedMetadata>;
    ...
    middlewaresByTargetAndFieldCache: Map<string, Set<MiddlewareMetadata>>;
    ...
    fieldDirectivesByTargetAndFieldCache: Map<string, DirectiveFieldMetadata[]>;
